...
//	--------------------------------------- 
var secret = encode('This is a secret message');
console.log(secret)
...
function encode(message){
	...
	for(var i = 0; i < message.length; i++){
		encoded = encoded + key.charAt(letters.indexOf(message.charAt(i)));
	}
	return encoded;
}
...
function decode(message){
	...
	var decoded = ''
	for(var i = 0;i < message.length;i++){
		decoded = decoded + letters.charAt(key.indexOf(message.charAt(i)));
	}
	return decoded;
}
